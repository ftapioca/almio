...
/**
 * Card — contenedor base (elevation-1). Usado por MetricCard, KPICard, EmployeeCard, etc.
 */
...
const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('text-h5 font-semibold leading-tight tracking-tight', className)} {...props} />
  ),
);
